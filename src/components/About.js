    ...
    return (
      <div className="about">
        ...
        <div className= 'about--social-media'>
          <svg className='about--lnr about--lnr-github'id="github" onclick="github()" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
          ...
          <svg className='about--lnr about--lnr-linkedin' id="linkedin" onclick="linkedin()" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
